...
* **Purpose**: Represents modifications applied over an existing StaticLiteRecord without committing yet.
* **Why needed**:
...
* **Often unnecessary**:
  ...
  * StaticLiteRecord can lazily load payload; metadata-only scans can be done via loaders.
...
* **Why typically unnecessary**:
  ...
  * Can convert directly into DynamicLiteRecord.
